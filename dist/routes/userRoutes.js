...
router.get("/get", _requireEmailPassword2.default, _TokenController2.default.checkToken,  _UserController2.default.show);
router.get("/get-all", _UserController2.default.index);
router.put("/update", _requireEmailPassword2.default, _TokenController2.default.checkToken,  _UserController2.default.update);
router.post("/create", _UserController2.default.store);
router.delete("/delete", _requireEmailPassword2.default, _TokenController2.default.checkToken,  _UserController2.default.delete);
